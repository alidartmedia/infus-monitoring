...
class AllOfflineDevicePagingSource @Inject constructor(private val mainApiService: MainApiService): PagingSource<Int, ProductsItemAllDeviceResponse>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ProductsItemAllDeviceResponse> {
        return try {
            ...
            val response = mainApiService.getAllOfflineDevicePagination(page)
